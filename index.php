      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            ...
            <p data-aos="fade-up" data-aos-delay="100">Our carefully designed rooms and suites offer the perfect blend of comfort and elegance. Each space is thoughtfully crafted with modern amenities, warm interiors, and breathtaking views, ensuring your stay in Sri Lanka is nothing short of extraordinary.</p>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            ...
            <p class="text-white" data-aos="fade" data-aos-delay="100">From the heart of Sri Lanka, where spices and flavors come alive, our dishes celebrate the rich culinary heritage of the island. From fragrant rice and curry to savory hoppers and kottu roti, every meal tells a story of tradition and taste, crafted with fresh local ingredients and a touch of love.</p>
          </div>
        </div>
        <div class="food-menu-tabs" data-aos="fade">
          <ul class="nav nav-tabs mb-5" id="myTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active letter-spacing-2" id="mains-tab" data-toggle="tab" href="#mains" aria-controls="mains" aria-selected="true">Our MAINS</a>
            </li>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            ...
            <p data-aos="fade-up">Located just a short drive from the bustling city of Colombo, our hotel puts you close to shopping, dining, and cultural landmarks. Explore vibrant streets, historic sites, and the lively coastal vibe, all while enjoying a peaceful retreat just outside the city.</p>
          </div>
        </div>
        <div class="row">
